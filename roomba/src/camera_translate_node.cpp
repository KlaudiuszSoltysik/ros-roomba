...
class CameraTranslate : public rclcpp::Node {
  public:
    CameraTranslate() : Node("camera_translate") {
      camera_sub = this->create_subscription<sensor_msgs::msg::Image>("camera", 10, std::bind(&CameraTranslate::cameraSubCb, this, std::placeholders::_1));
  ...
  private:
    ...
    void cameraSubCb(const sensor_msgs::msg::Image & msg) {
      ...
      std::string encoded = base64Encode(enc_msg, jpeg_data.size());
